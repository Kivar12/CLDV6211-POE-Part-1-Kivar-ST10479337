...
namespace EventEaseAssignment.Controllers
{
    public class VenuesController : Controller
    {
        ...
        public VenuesController(EventEaseAssignmentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VenueId,VenueLocation,VenueName,Capacity,VenueImageURL")] Venues venues)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VenueId,VenueLocation,VenueName,Capacity,VenueImageURL")] Venues venues)
        {
